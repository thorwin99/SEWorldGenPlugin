...
{
    internal sealed class MySEWGCsgTorus : MySEWGCsgShapeBase
    {
        ...
        internal MySEWGCsgTorus(Vector3 translation, Quaternion invRotation, float primaryRadius, float secondaryRadius, float secondaryHalfDeviation, float deviationFrequency, float detailFrequency)
        {
        ...
        internal override MySEWGCsgShapeBase DeepCopy()
        {
            return new MySEWGCsgTorus(m_translation, m_invRotation, m_primaryRadius, m_secondaryRadius, m_secondaryHalfDeviation, m_deviationFrequency, m_detailFrequency);
        }
