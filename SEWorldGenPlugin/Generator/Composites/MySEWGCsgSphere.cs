...
{
    internal class MySEWGCsgSphere : MySEWGCsgShapeBase
    {
        ...
        public MySEWGCsgSphere(Vector3 translation, float radius, float halfDeviation = 0f, float deviationFrequency = 0f, float detailFrequency = 0f)
        {
        ...
        {
            return new MySEWGCsgSphere(m_translation, m_radius, m_halfDeviation, m_deviationFrequency, m_detailFrequency);
        }
