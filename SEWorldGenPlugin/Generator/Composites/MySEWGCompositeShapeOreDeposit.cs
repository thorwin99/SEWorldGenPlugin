...
{
    internal class MySEWGCompositeShapeOreDeposit
    {
        public readonly MySEWGCsgShapeBase Shape;
        ...
        public MySEWGCompositeShapeOreDeposit(MySEWGCsgShapeBase shape, MyVoxelMaterialDefinition material)
        {
            Shape = shape;
            m_material = material;
        }
