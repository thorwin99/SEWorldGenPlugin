...
{
    internal class MySEWGCsgCapsule : MySEWGCsgShapeBase
    {
        ...
        public MySEWGCsgCapsule(Vector3 pointA, Vector3 pointB, float radius, float halfDeviation, float deviationFrequency, float detailFrequency)
        {
            m_pointA = pointA;
            m_pointB = pointB;
            m_radius = radius;
        ...
        internal override MySEWGCsgShapeBase DeepCopy()
        {
            ...
            return new MySEWGCsgCapsule(m_pointA, m_pointB, m_radius, halfDeviation, deviationFrequency, detailFrequency);
        }
