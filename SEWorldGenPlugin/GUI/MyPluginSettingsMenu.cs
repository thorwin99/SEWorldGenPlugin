...
namespace SEWorldGenPlugin.GUI
{
    ...
    public class MyPluginSettingsMenu : MyGuiScreenBase
    {
        ...
        public override void RecreateControls(bool constructor)
        {
            ...
            m_systemGeneratorCombo.AddItem((long)SystemGenerationMethod.NONE, "Empty system");
            ...
            m_asteroidGeneratorCombo.SetToolTip("The type of asteroid generator to use for this world.");
            ...
            m_enableVanillaPlanetsCheckbox.SetToolTip("Whether vanilla planets are allowed to be generated by the plugin.");
            ...
            m_planetCountSlider.SetToolTip("The minimum and maximum amount of planets in the system. The generator will choose a random number in this range. To specify an exact amount, set min and max equal.");
            ...
            m_asteroidCountSlider.SetToolTip("The minimum and maximum amount of asteroid objects, such as asteroid belts, in the system. This does not include asteroid rings around planets currently. " +
            ...
            m_orbitDistancesSlider.SetToolTip("The range for orbit distances between the system objects. In KM");
            ...
            m_systemPlaneDeviationSlider.SetToolTip("The angle the orbits of planets can deviate from the system plane.");

            parent.AddTableRow(planeDeviationLabel, m_systemPlaneDeviationSlider);

            m_asteroidDensitySlider = new MyGuiControlClickableSlider(minValue: 0.1f, maxValue: 0.99f, defaultValue: 0.6f, width: 0.25f, showLabel: true);
            ...
            m_worldSizeSlider.SetToolTip("The max size of the system. After that nothing will be generated. In KM");
            ...
            m_planetSizeCapSlider.SetToolTip("The max size a planet can have in this system. In metres");
            ...
            m_planetSizeMultSlider.SetToolTip("The multiplier for the planets size. 1G planet equals to 120km * this value. Gravity is fixed for each planet, only Diameter will be affected. A gas giant will be double the size.");
            ...
            m_planetRingBasePropSlider.SetToolTip("The base probability for a planet to generate a ring. Scales with gravity, so higher gravity means higher probability.");
            ...
            m_planetMoonMinMaxSlider.SetToolTip("The minimum and maximum limits for the amount of moons around a planet.");

            parent.AddTableRow(planetMoonCountLabel, m_planetMoonMinMaxSlider);

            m_planetGPSModeCombo = new MyGuiControlCombobox();
            m_planetGPSModeCombo.SetToolTip("The generation mode for planet gpss. Discovery means a player needs to be within 50k km to see the dynamic gps.");
