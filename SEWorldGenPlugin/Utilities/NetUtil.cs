...
namespace SEWorldGenPlugin.Utilities
{
    ...
    public class NetUtil
    {
        ...
        /// <summary>
        /// Handler ID for the ping handler
        /// </summary>
        ...
        /// <summary>
        /// Pings the server and calls the callback on success.
        /// </summary>
        /// <param name="successCallback">Callback for success</param>
        /// Registers a new message handler for every ping, because they compare the
        /// id of the pong with the id of the ping.
        ...
        /// <summary>
        /// Handles ping messages to and from the server.
        /// </summary>
        /// <param name="senderId">Id of the sender, that send the packet</param>
        ...
        /// <summary>
        /// Builds a ping message with the given id
        /// </summary>
        /// <param name="id">Id of ping</param>
        /// <returns>Message of ping</returns>
        private static string GetPingMsg(int id)
        {
            return GetPingRawMsg() + id;
        }

        /// <summary>
        /// Builds a pong message with the given id
        /// </summary>
        /// <param name="id">Id of pong</param>
        /// <returns>Message of pong</returns>
        ...
        /// <summary>
        /// Returns a raw ping message, without id
        /// </summary>
        /// <returns>Ping message</returns>
