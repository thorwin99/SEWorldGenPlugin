...
namespace SEWorldGenPlugin.Networking
{
    ...
    public class MyPluginEventHandler : MySessionComponentBase
    {
        ...
        /// </summary>
        private MethodInfo m_unpackData = typeof(MyPluginEventHandler).GetMethod("UnpackData", BindingFlags.Instance | BindingFlags.NonPublic);

        public static MyPluginEventHandler Static;
